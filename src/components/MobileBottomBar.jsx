...
import { Home, Sparkles, Layers, Info, ShoppingBag } from 'lucide-react';
    ...
    >
      <div className="grid grid-cols-5 items-center h-16 px-1">
        ...
        >
          ...
          <span className="text-[9px] tracking-tight">Categories</span>
        </button>
        ...
        >
          ...
          <span className="text-[9px] tracking-tight">Shop</span>
        </button>
        ...
        >
          <div className="relative">
            ...
            {totalCartCount > 0 && (
              <span className="absolute -top-1.5 -right-2.5 bg-gradient-to-r from-red-600 to-rose-600 text-white text-[9px] font-black w-4 h-4 rounded-full flex items-center justify-center shadow-md shadow-rose-600/30 animate-pulse">
                {totalCartCount}
              </span>
            )}
          </div>
          <span className="text-[9px] tracking-tight text-rose-600 font-black">
